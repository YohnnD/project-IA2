                        ...
                        <div class="card-footer center-align">
                            <div class="row" style="margin-bottom: 0">
                                <div class="col s12 m6 center-align">
                                    <button type="submit" href="#!" class="btn btn-large blue-gradient waves-effect waves-light col s12" id="modify">
                                ...
                                <div class="col s12 m6 center-align">
                                    <a href="#!" class="btn btn-large red-gradient waves-effect waves-light col s12" id="delete">
