                        ...
                        <div class="card-footer">
                            <div class="row" style="margin-bottom: 0">
                                ...
                                <div class="col s12 m6 center-aling">
                                    <a href="<?php echo Helpers::url('Material','details')."/".$result->id_material?>" style="display: none" class="btn btn-large green-gradient waves-effect waves-light col s12" name="back" id="back">
