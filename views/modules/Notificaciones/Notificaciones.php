                    ...
                    <div class="col s12 m6 l6 xl6">
                        <div class="card grey darken-4">
                            ...
                            <div class="card-action">
                                <p>
                                    <a href="<?php echo Helpers::url('Pedido','details')."/".$pedido->codigo_pedido; ?>">Ir a Pedido</a>
                                </p>
                            </div>
                        </div>
                    </div>
                   ...
                   <?php if (empty($allProdu)){ ?>
                    ...
                    <div class="col s12 m6 l6 xl6">
                        <div class="card grey darken-4">
                            ...
                            <div class="card-action">
                                <p><a href="<?php echo Helpers::url('Producto','details'); ?>/<?php echo $producto->codigo_producto; ?>">Ir a Producto</a></p>
                            </div>
                        </div>
                    </div>
