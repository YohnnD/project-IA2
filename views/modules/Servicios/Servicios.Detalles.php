                    ...
                    <div class="card-content row" style="margin-bottom: 0">
                        <?php if(!empty($materiales)): 
                            ...
                            <div class="input-field col s12 m2 l2 " >
                                <a href="<?php echo Helpers::url('Servicio','deleteMaterial');?>/<?php echo $resul->id_material?>" class="btn red waves-effect btn-rounded waves-light col s12 materiales" disabled>
                    ...
                    <div class="card-footer">
                        <div class="row" style="margin-bottom: 0">
                            ...
                            <div class="col s12 m6 center-align" style="margin-bottom: 1rem">
                                <a href="#" class=" materiales btn blue-gradient btn-rounded waves-effect waves-light col s12" id="modify">
                            ...
                            <div class="col s12 m6 center-align" style="margin-bottom: 1rem">
                                <a href="#" class="btn red-gradient btn-rounded waves-effect waves-light col s12" id="delete">
                                    <i class="icon-delete right"></i>
                                    Eliminar
                                </a>                
                            </div>
                            ...
                            <div class="col s12 m6 center-align">
                                <a href="<?php echo Helpers::url('Servicio','getMateriales');?>/<?php echo $value['id_servicio']?>" class="btn green-gradient btn-rounded waves-effect waves-light col s12" id="addMaterial">
                            ...
                            <div class="col s12 m6 center-align">
                                <a href="#" class="btn btn-rounded red-gradient waves-effect waves-light col s12" id="deleteMaterial">
                                    <i class="icon-delete right"></i>
                                    Eliminar Material
                                </a>
                            </div>
