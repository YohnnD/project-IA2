    ...
    <div class="contaner-fluid">
        <div class="row">
            <div class="col s12 breadcrumb-nav left-align">
                ...
                <a href="<?php echo Helpers::url('Auditoria','index'); ?>" class="breadcrumb">Auditoría</a>
                <a href="#" class="breadcrumb">Consulta Auditoría</a>
            </div>
            <div class="col s12">
                <div class="card">
                    <div class="card-header center-align">
                        <h4>Consultar Acciones de la Tabla <?php echo(ucwords($name)) ?></h4>
                    </div>
